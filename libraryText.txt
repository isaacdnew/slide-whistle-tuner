// This uses an FFT library not available in TinkerCad,
// so I had to paste the header and .cpp files as text below.
// In the phsyical version, this will be accomplished as one line:
// #include "arduinoFFT.h"

/* BEGIN HEADER FILE (arduinoFFT.h) */
...
#ifdef ARDUINO
	#if ARDUINO >= 100
		// This is not commented in the actual library,
		// but it causes errors in TinkerCad
		// #include "Arduino.h"
	#else
...
// This is not commented in the actual library, but the header's included already
// #include "arduinoFFT.h"
